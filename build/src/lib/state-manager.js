...
class StateManager {
    ...
    packageId(delivery) {
        ...
        if (typeof delivery.extra_information === "string" &&
    ...
    async updateDelivery(delivery, carrierName) {
        ...
        const trackingNumber = typeof delivery.tracking_number === "string"
            ? delivery.tracking_number
            : "";
        const extraInfo = typeof delivery.extra_information === "string"
    ...
    calculateDeliveryEstimate(delivery, statusCode) {
        ...
        else if (typeof delivery.date_expected === "string" &&
